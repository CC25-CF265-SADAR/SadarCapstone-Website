export const questions = [
  ...
  },
  {
    ...
    options: [
    { text: 'Mengabaikan perbedaan kecil pada domain karena isi email terlihat profesional', category: 'Berisiko' },
    { text: 'Mengecek alamat situs resmi kampus dari brosur atau sumber resmi kampus', category: 'Aman' },
    { text: 'Melaporkan email mencurigakan ke bagian TI atau helpdesk universitas', category: 'Aman' },
    { text: 'Login langsung ke situs dari link email yang tampilannya mirip portal asli', category: 'Berisiko' },
  ],
  dropZones: ['Aman', 'Berisiko']
  },
  {
  ...
  },
  {
    id: 11,
    type: "mcq",
    question: "Kamu sedang di pusat perbelanjaan dan temanmu menelepon, butuh transfer uang darurat. Kamu hanya bisa mengakses internet melalui Wi-Fi publik mal. Apa yang akan kamu lakukan untuk transfer melalui mobile banking?",
    options: [
  ...
  },
  {
    id: 12,
    type: "mcq",
    question: "Kamu sedang di kafe 'Kafe Nyaman' dan perlu segera mengirim email pekerjaan yang berisi data klien. Kafe menyediakan Wi-Fi gratis bernama 'KafeNyaman_FreeWiFi' tanpa kata sandi. Apa tindakanmu?",
    options: [

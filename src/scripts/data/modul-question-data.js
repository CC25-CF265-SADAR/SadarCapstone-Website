export const moduleQuestions = {
  'mod-1': [
    ...
    },
    {
      id: 'mod-1-q2',
      type: 'mcq',
      question: 'Salah satu ciri akun WhatsApp palsu yang sering digunakan untuk menipu adalah...',
      options: [
        'Menyapa dengan sapaan sopan',
        'Memiliki centang hijau',
        'Foto profilnya blur',
    ...
    },
    {
      ...
      options: [
        ...
        'Transfer cepat agar tidak kehabisan slot',
    ...
    },
    {
      ...
      options: [
        ...
        'OTP adalah kunci akses sementara yang bisa disalahgunakan',
    ...
    },
    {
      id: 'mod-1-q5',
      type: 'mcq',
      question: 'Berikut ini yang termasuk contoh social engineering adalah...',
      options: [
        'Petugas palsu menelepon dan memancing korban memberikan OTP',
        'Email spam berisi tawaran promosi',
  ...
  'mod-2': [
    {
      ...
      options: [
        ...
        'Mencuri nama pengguna, kata sandi, dan data perbankan Anda',
    ...
    },
    {
      id: 'mod-2-q2',
      type: 'mcq',
      question: 'Manakah di bawah ini yang BUKAN merupakan ciri umum dari email phishing?',
      options: [
        'Menggunakan alamat email yang sedikit berbeda dari aslinya',
        'Menawarkan diskon besar untuk produk terkenal',
        'Meminta Anda untuk memperbarui informasi akun Anda',
    ...
    },
    {
      ...
      options: [
        ...
        'Balas email tersebut dan tanyakan kebenarannya',
    ...
    },
    {
      ...
      options: [
        ...
        'Tidak pernah membagikan informasi pribadi secara online',
  ...
  'mod-5': [
    {
      ...
      options: [
        'Teknik hacking menggunakan perangkat lunak berbahaya',
        'Proses mencuri data melalui jaringan Wi-Fi',
        'Teknik manipulasi psikologis untuk mendapatkan informasi rahasia',
    ...
    },
    {
      id: 'mod-5-q4',
      type: 'mcq',
      question: 'Dalam teknik pretexting, biasanya pelaku...',
      options: [
        'Menyediakan perangkat lunak gratis',
        'Memberikan undian palsu',
        'Mengaku sebagai pihak resmi untuk meminta data penting',
    ...
    },
    {
      id: 'mod-5-q5',
      type: 'mcq',
      question: 'Salah satu cara agar terhindar dari penipuan social engineering adalah...',
      options: [
        'Mengunggah data pribadi secara rutin agar tidak dicurigai',
        'Memasang aplikasi dari sumber tidak dikenal',
  ...
  'mod-6': [
    {
      id: 'mod-6-q1',
      type: 'mcq',
      question: 'Apa yang dimaksud dengan penipuan money rule?',
      options: [
        'Penipuan yang melibatkan pembelian produk palsu secara online',
    ...
    },
    {
      id: 'mod-6-q2',
      type: 'mcq',
      question: 'Salah satu ciri utama dari penipuan money rule adalah...',
      options: [
        'Menggunakan kontrak legal yang terdaftar di notaris',
        'Menawarkan keuntungan besar dan realistis',
        'Tidak menyediakan dokumen legal atau izin usaha yang sah',
    ...
    },
    {
      id: 'mod-6-q3',
      type: 'mcq',
      question: 'Contoh modus money rule yang sering digunakan pelaku adalah...',
      options: [
        'Menyuruh korban membayar "pajak hadiah" sebelum hadiah dikirim',
        'Menawarkan barang dengan harga diskon besar-besaran',
        'Meminta korban menyewa ruangan kantor terlebih dahulu',
    ...
    },
    {
      id: 'mod-6-q4',
      type: 'mcq',
      question: 'Apa langkah yang sebaiknya dilakukan untuk mencegah tertipu penipuan money rule?',
      options: [
        'Menyimpan semua nomor tidak dikenal dalam kontak',
        'Selalu menerima tawaran bisnis dari luar negeri',
        'Tidak membagikan informasi pribadi dan melakukan riset bisnis',
    ...
    },
    {
      id: 'mod-6-q5',
      type: 'mcq',
      question: 'Apa perbedaan utama antara penipuan money rule dan prosedur resmi?',
      options: [
        'Penipuan money rule melibatkan surat undangan resmi',
        'Penipuan menggunakan komunikasi lewat chat tidak resmi dan mendesak',
        'Prosedur resmi meminta data pribadi lengkap tanpa alasan jelas',

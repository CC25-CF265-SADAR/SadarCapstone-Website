...
export default class ResetPasswordPage {
  async render() {
    return `
      <section data-aos="zoom-in" data-aos-delay="100" class="max-w-md mx-auto p-6 mt-20">
        ...
        <form id="resetForm" class="space-y-4 mt-8">
          ...
          <button type="submit" class="cursor-pointer w-full text-white bg-[#378BA2] hover:bg-[#2C6F82] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-md px-8 py-3 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Perbarui Password</button>
        </form>
